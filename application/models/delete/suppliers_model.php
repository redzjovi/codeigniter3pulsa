...
class suppliers_model extends CI_Model {
    ...
    {
        $data['password'] = 'supplier';
		$user_id = $this->users_model->add($data, 'supplier');
	...
	public function edit($data)
    {
        ...
        $this->db->where($this->users_model->primary_key, $data[$this->primary_key]);
        $this->db->update($this->table_name);   
    }
    
    public function list_all($param)
    {
        $usertype_id = $this->usertype_model->get_id_by_code('supplier');
		...
		$this->db->join($this->table_name.' as ud', 'ud.'.$this->primary_key.' = u.'.$this->users_model->primary_key);
    ...
    public function list_all_for_product()
    {
		...
		$data = $this->db->select('u.user_id, ud.name')
			->from($this->users_model->table_name.' as u')
			->join($this->table_name.' as ud', 'ud.'.$this->primary_key.' = u.'.$this->users_model->primary_key)
	...
	public function row($id)
	{
		...
		$this->db->where('ud.'.$this->primary_key, $id);
		$this->db->where('ut.usertype_code', 'supplier');
